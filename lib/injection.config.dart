...
// ignore_for_file: unnecessary_lambdas, prefer_relative_imports
...
import 'package:dddapplication/infrastructure/core/firebase_injectable_module.dart'
    as _i16;
import 'package:dddapplication/infrastructure/notes/notes_repository.dart'
    as _i10;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i9.INoteRepository>(
        () => _i10.NoteRepository(gh<_i5.FirebaseFirestore>()));
    gh.factory<_i11.NotesActorBloc>(
        () => _i11.NotesActorBloc(gh<_i9.INoteRepository>()));
    gh.factory<_i12.NotesFormBloc>(
        () => _i12.NotesFormBloc(gh<_i9.INoteRepository>()));
    gh.factory<_i13.NotesWatcherBloc>(
        () => _i13.NotesWatcherBloc(gh<_i9.INoteRepository>()));
